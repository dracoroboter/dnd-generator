...
### Trap (entrance gallery)
- **Where**: 4qd from the entrance (2qd before the end of the gallery)
- **What**: ankle-height tripwire + dart mechanism in the wall
- **Map mark**: a dashed line across the corridor
- Perception DC 12 to spot it, Dexterity DC 12 to disarm it

### Clues at the junction
- **North branch**: FALSE muddy footprints toward the water (Survival DC 13)
- **East branch**: real tracks, less obvious
...
1. **Start from the grate** — draw the gallery rectangle, mark the trap with an X
2. **At the junction** make the T — players will choose where to go, only draw the branch they explore
3. **The nest** is the first real room — draw it larger, mark the rat positions
4. **The tunnel to the threshold** widens — show it graphically, it's the signal that something changes
5. **At the threshold** change your stroke if you can (thicker line, different color) to mark the transition
6. Don't draw everything at once — reveal zone by zone as the PCs advance
