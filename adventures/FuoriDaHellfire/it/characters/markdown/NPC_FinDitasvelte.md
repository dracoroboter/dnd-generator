...
- **Velocità**: 7,5m / 25ft / 5qd
- **Iniziativa**: +3
- **Bonus competenza**: +2
- **Tiri salvezza**: DES +5, INT +3
- **Abilità**: Acrobazia +5, Furtività +7 (expertise), Rapidità di mano +7 (expertise), Percezione +2, Indagare +3, Inganno +4
- **Sensi**: nessuno speciale
- **Lingue**: Comune, Halfling, Gergo dei Ladri
- **Tratti razziali**: Fortunato (ritira 1 naturale), Coraggioso (vantaggio vs spaventato), Agilità Halfling (muoversi attraverso creature più grandi)

## Attacchi

### Pugnale (mischia/distanza)
- **Attacco**: +5, mischia o distanza 6m / 20ft / 4qd
- **Danni**: 1d4+3 perforanti
- **Sneak Attack**: +2d6 se ha vantaggio o un alleato in mischia col bersaglio

### Arco corto (distanza)
- **Attacco**: +5, distanza 24m / 80ft / 16qd
- **Danni**: 1d6+3 perforanti

## Capacità notevoli

- **Sneak Attack** (2d6): una volta per turno, danni extra se ha vantaggio o alleato adiacente al bersaglio
- **Cunning Action**: Dash, Disengage o Hide come azione bonus
- **Fast Hands** (Thief): Rapidità di mano, usare arnesi da scasso, o usare un oggetto come azione bonus
- **Second-Story Work**: velocità di scalata pari alla velocità di movimento
