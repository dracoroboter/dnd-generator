...
- **Immunità**: veleno
- **Sensi**: scurovisione
- **Lingue**: Comune, Elfico, lingue dei mostri delle fogne

## Attacchi

### Rancid Knife (mischia)
- **Attacco**: +5, mischia
- **Danni**: 2d4+3 perforanti + 2d6 veleno
- **Effetto**: il bersaglio è avvelenato fino all'inizio del prossimo turno di Korex

### Flauto Magico (azione)
- **Bersaglio**: una creatura che Korex può vedere entro 36m / 120ft / 24qd
- **Tiro salvezza**: Saggezza CD 12
- **Fallimento**: 4d6 danni psichici + charmato fino all'inizio del prossimo turno di Korex
- **Successo**: metà dei danni, nessun charm

## Azioni bonus

- **Disengage**: Korex può disimpegnarsi come azione bonus
- **Dash**: Korex può usare Dash come azione bonus (velocità raddoppiata: 24m / 80ft / 16qd)

## Capacità notevoli

- **Immunità al veleno**: Korex è immune alla condizione avvelenato e ai danni da veleno
- **Flauto Magico**: arma principale. Charm + danni psichici a distanza. Devastante contro bersagli con Saggezza bassa.
- **Rancid Knife**: arma di riserva in mischia. Il veleno avvelena automaticamente al colpo.
...
- **Modulo 1**: assente fisicamente, ma la sua presenza si sente ovunque (trappole, marchi sui muri, eco di musica).
- **Modulo 2**: boss fight. Combatte dalla distanza, charma, manda avanti i servitori. Se messo alle strette, implora o fugge.
- **Post-avventura**: se vivo, fonte di informazioni inaffidabili. Se morto, i suoi appunti parlano per lui.
