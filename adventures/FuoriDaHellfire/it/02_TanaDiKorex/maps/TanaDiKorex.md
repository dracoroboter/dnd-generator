...
Legenda:
- `Cn` `Ce` `Cs` `Cw` = colonne (nord, est, sud, ovest), a ~2qd dal centro
- `██` = rialzo cisterna (piattaforma 3qd Ø, alta 1qd / 1,5m)
- `···` = area alcova + passaggio nascosto (parete nord-est / sud-est)
- Teppista 1: dietro colonna **est** (Ce)
- Teppista 2: dietro colonna **sud** (Cs)

## Misure rapide

| zona | dimensioni | note |
|------|-----------|------|
| Tunnel d'accesso | 4×3 qd | dalla soglia, entra da ovest |
| Cisterna | 8qd Ø (~12m) | circolare, disegna come ottagono |
| Rialzo centrale | 3qd Ø, alto 1qd | vecchia cisterna, Korex è qui |
| Colonne | 4, a croce, ~2qd dal centro | copertura mezza (+2 CA) |
| Alcova di Korex | 3×2 qd | parete NE, dietro tendaggio |
| Passaggio nascosto | apertura 1qd | dietro colonna crollata SE |
...
- **Dove**: nicchia coperta da tendaggio, visibile solo avvicinandosi
...
|-------|-------|----------|
| 1 | Charm sul PG più pericoloso | escono dalle colonne, attaccano |
| 2-3 | incantesimi di controllo, distanza | mazza, proteggono Korex |
| sotto 50% PF | implora pietà, mente, tenta fuga verso passaggio SE | continuano o si arrendono se Korex cade |

### Terreno
- **Rialzo**: salire costa 1qd di movimento extra (o Atletica CD 10 per saltare su)
- **Colonne**: copertura mezza (+2 CA, vantaggio TS Destrezza)
- **Tendaggio alcova**: si può strappare o tagliare (nessun tiro)
