# DM Prep - Sessione 7 (5 giugno 2026)

**Puntata:** 5 - Ritorno alle Fogne (Atto 2 indagine + Atto 4 dungeon)
**PG:** 4, livello 3 → **lv4** dopo rapporto ad Arimano
**Sessione precedente:** Incarico Arimano ricevuto (1 mo/testa anticipo)
...
3. Visitano 2-3 NPC (ordine libero):
   ...
   - **Ortensia** (Aviano): parla se adulata, conferma qualcuno là sotto
   - **Gorim** (castello): conflitto interiore, ammette a metà, menziona il Burmini
   - **Scannabue** (Aviano): pista morta comica, non sa niente
4. Se bloccati: **scaricatore di porto** (Sergius) indirizza a Spaccafegato
5. Se ancora bloccati: **lettera anonima** alla Taberna (fallback finale)
6. Convergenza: Michelangeli è nel dungeon sotto il castello
