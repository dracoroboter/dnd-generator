...
Nessuno sa cosa sia l'Anello. Nessuno sa a cosa serva. Nessuno sa dove sia. E nessuno sa come si chiami il Conte.
...
Ogni volta che un NPC sta per dire il nome del Conte, viene interrotto:

- Rumore fortissimo che copre la parola
- Starnuto
- Crollo di qualcosa
...
Tutti ne parlano, nessuno sa cosa fa, nessuno sa dov'è:

- Ogni NPC ha una teoria diversa e incompatibile
- Qualcuno giura di averlo visto (era un anello di cipolla)
- Gorim è convinto che i PG sappiano già tutto
- Si trova solo nell'ultima puntata, dove "tutto sarà chiaro a tutti"

### Paralleli Boris

| Boris                                                | L'Anello del Conte                                   |
| ---------------------------------------------------- | ---------------------------------------------------- |
| "La serie" (Gli Occhi del Cuore) che nessuno capisce | "La missione" (trovare l'Anello) che nessuno capisce |
| René Ferretti                                        | Sir Gorim Vel                                        |
| Stanis La Rochelle                                   | Pipinius Chennedius (PG)                             |
| Duccio                                               | Gin Tonica (PG)                                      |
| Corinna                                              | Maria Biscanna (PG)                                  |
...
Elementi da seminare nelle puntate comiche:

- Gorim a volte si ferma a metà frase, preoccupato per motivi che vanno oltre l'incompetenza locale
- Il Conte riceve ordini da qualcuno più in alto (il Re?) — accenni vaghi
- Nelle vicinanze c'è una miniera abbandonata (Nerrok) che "nessuno vuole visitare"
- La morte del Conte nell'ultima puntata non è comica — è il momento in cui la commedia finisce
- Gorim riceve un messaggio urgente dalla capitale dopo l'esplosione: il Re vuole vederlo
- Il vuoto di potere lasciato dal Conte trascina i PG nella storia più grande di Drakenhold

### L'arco di Gorim (SPOILER — solo per il DM)

Dopo l'esplosione che uccide il Conte, Gorim cambia. Non è più il funzionario esasperato — è un uomo che ha perso il suo signore e non ha potuto fare nulla. Tra L'Anello del Conte e Il Re Spezzato passa **un anno**. In quell'anno Gorim viene convocato a corte e diventa il confidente e servitore di Re Dorian Valemarch. Quando i PG lo ritrovano nel Re Spezzato, è un uomo diverso: serio, stanco, leale fino all'osso. Il contrasto con il Gorim comico dell'Anello del Conte è il segnale più forte che il tono è cambiato.

Nelle puntate comiche, seminare piccoli momenti in cui Gorim mostra una lealtà e un senso del dovere che vanno oltre la gag — sono i tratti che Dorian noterà e che lo porteranno a sceglierlo come confidente.
