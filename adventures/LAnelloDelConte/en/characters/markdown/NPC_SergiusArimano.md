...
- **Skills**: Stealth +7, Deception +2, Investigation +6, Perception +2, Sleight of Hand +5
...
- **Expertise**: Stealth, Investigation (double bonus already included)
- **Sneak Attack (2d6)**: once per turn, extra damage if he has advantage or an ally is adjacent to the target
- **Cunning Action**: bonus action: Dash, Disengage, or Hide
- **Assassinate**: advantage on attack rolls against creatures that haven't acted yet. Automatic critical hit against surprised creatures.
- **Ring of Shadows** (magic item): can cast *Invisibility* (on self) 1/day. Doesn't require concentration but ends if he attacks or casts a spell.
...
Hidden antagonist throughout the adventure. The PCs don't know of his existence at the start. Each episode contains clues left by him, signed with an interlocking "S." In the final episode the PCs find him and bring him to the Count. He says he'll reveal the Ring's location only to the Count in person. The final explosion kills them both.

## DM Notes

- Sergius doesn't fight if he can avoid it. He runs, turns invisible, vanishes.
...
- ~~How he was cheated by the Count~~ → ✅ Gabella Pudicitiae imposed by La Contessina + unpaid portrait
- ~~What illicit trade he runs in the sewers~~ → ✅ Vigor potions and erotic portraits via sea, warehouse in the sewers
- ~~How the PCs discover his existence (which episode?)~~ → ✅ Episode 1: letter signed "S". Episode 2: speech at the Festival. The name "Marchese Arimano" emerges in Episode 3.
- [ ] Who or what causes the final explosion

## Future Hooks

None direct. Sergius dies in the final explosion along with the Count.
