...
- **Full name**: Er Braccio (The Arm)
- **Role**: bandit leader, port crime boss
- **Race**: Human
...
- **Multiattack**: Er Braccio makes three melee attacks: two with his scimitar and one with his dagger.
...
### Dagger (melee/ranged)
- **Attack**: +5, melee 5ft or ranged 20/60 ft.
...
Main antagonist of the Warehouse 4 combat (Episode 3). He negotiates first (wants 20 gp for the goods), fights if negotiation fails, then escapes in the rhinoceros chaos. He probably reappears in later episodes.
