...
- **Role**: main ally, quest giver
- **Class**: Fighter 3 (Defence)
- **Level**: 3
- **Race**: Human
...
- "Splendid. Wonderful." (sarcastic)
- "What are you doing?!"
- "I can't take it anymore with you lot"
...
- **Skills**: Persuasion +4, Insight +3, Intimidation +4, History +3
...
- **Fighting Style: Defense**: +1 AC when wearing armor (already included)
- **Second Wind (1/short rest)**: bonus action, recovers 1d10+3 HP
- **Action Surge (1/short rest)**: one additional action on his turn
- **Rallying Cry**: when he uses Second Wind, up to 3 allies within 60ft / 12sq recover 3 HP each. Mechanically: Gorim shouts "MOVE IT, COME ON!" and everyone feels slightly better, more from fear than inspiration.

## Attacks

### Longsword (melee)
- **Attack**: +4, melee, reach 5ft / 1sq
...
After the explosion that kills the Count in the final episode, something breaks in him. A year passes. Gorim is summoned to court by King Dorian Valemarch and becomes his most trusted confidant and servant. When the PCs find him again in Il Re Spezzato, he's a different man: serious, weary, loyal to the bone. The contrast with the Gorim they knew is the strongest signal that the tone has changed forever.
