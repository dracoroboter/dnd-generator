...
#### Taberna de Franciosibus (Mercato Centrale)
...
| NPC | Stat block | Note |
|-----|-----------|------|
| Terzilio | Commoner (MM p. 345) | Verduraio, indica la botola |
| 2× Guardia | Guard (MM p. 347) | Presidio residenza del Conte |
...
| Stat block | Quanti |
|-----------|--------|
| Sir Gorim Vel (custom) | 1 |
| Domina Lella (custom) | 1 |
| Commoner | 2 (Terzilio, Ermolao) |
| Guard | 2 |
| Giant Rat | 5 |
| Ogre (PF 30) | 1 |
...
| Thug | 3 |
| Noble | 3 (Grigius Voidus, Donna Ortensia, Contessina) |
| Commoner | 3 (Flavia, Mastro Cecio, Terzilio) |
...
- [ ] Creare NPC markdown + XML + PNG per Noble (Grigius Voidus, Donna Ortensia, Contessina)
- [ ] Creare NPC markdown + XML + PNG per Commoner (Flavia, Mastro Cecio, Terzilio)
