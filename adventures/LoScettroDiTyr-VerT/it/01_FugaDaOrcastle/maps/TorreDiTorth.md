...
### Livello 2 — Stanza dell'Altare (cima della torre)
...
- **Due statue:** Figure avvolte in mantelli che brandiscono scettri, occhi incastonati di onice. Ai lati dell'altare.
- **Altare di pietra nera:** Sopra ci sono decine di coppe. Tra queste si nasconde la **Coppa di Blackwood**.
- **Vasca di pietra:** Piena di ceneri. Di fronte all'altare.
- **Pozzo:** Chiuso. Si apre solo completando il rituale (vedi Note per il DM).
...
### Livello 3 — Dungeon Sotterraneo (sotto il pozzo)

```
    [POZZO / SCALA IN PIETRA]
              │
              ▼
    ┌─────────────────────┐
    │  CORRIDOIO STRETTO  │
...
**Prova 1 — Sala del Riflesso:**
- Pavimento lucido come specchio.
- I doppi dei PG emergono dal pavimento e attaccano.
- Rune sulla parete opposta con la frase: "L'ombra non è nulla senza la luce, l'ombra ha il potere che gli dai."
...
### Rituale per aprire il Pozzo (Livello 2 → Livello 3)

Servono almeno **2 passaggi su 3**:

1. **Offrire il sangue** — Un PG offre sangue sull'altare (1d6 danni necrotici). Il sangue viene assorbito, la vasca emette bagliore rosso.
...
Gestire come copie semplificate: solo attacchi base (arma principale) e cantrip, no incantesimi con slot né abilità di classe. Stessi PF e CA ma nessun oggetto magico attivo. I danni fatti dai doppi sono psichici. Detect Magic rivela illusione. Le ombre scompaiono dopo aver ferito almeno tre personaggi. L'obiettivo è la scoperta che ignorarli è la soluzione.
