...
| C6 | ~~Timeline maledizione~~ | RISOLTO | Il preludio del Modulo 4 dice già "va adattato dal DM in base al tempo trascorso". A discrezione del DM in base al ritmo. |
...
| C10 | ~~Prove purezza Tyr~~ | RISOLTO | Le prove sono nelle sale del dungeon: Sala 4 (magnanimità/perdonare il golem), Sala 8 (rinnegare il male/promettere bene), Sala 9 (non attaccare le ombre/comprendere). Collegamento implicito ma chiaro. |
