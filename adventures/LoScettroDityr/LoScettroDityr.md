...
- **Modulo A — Fuga da Orcastle**: i PG, rapiti e dotati di collari esplosivi, devono recuperare la Pergamena del Giudizio nella città-prigione di Orcastle e trovare un modo per fuggire. Quattro fazioni controllano l'isola, ognuna con i propri segreti.
- **Modulo B — Lo Scettro di Tyr**: Vecna incarica i PG di recuperare lo Scettro dal Tempio di Lumina. Viaggio da Baldur's Gate attraverso montagne pericolose, prove di purezza nel tempio, e scontro finale con Alaric il Giusto.
- **Modulo C — Ritorno a Casa**: i PG devono riconsegnare lo Scettro all'altare di Tyr a Svoalbard. Viaggio via nave lungo la Costa della Spada, inseguiti da una spia di Vecna e dal warlock Othran Vorash.
- **Modulo D — La fine non appartiene ai morti**: Malebranche, sconfitto, evoca il mago Zikle e maledice i PG. I morti si rialzano ovunque passino. Devono trovare il Monile d'Oro di Ostegard per spezzare la maledizione e sconfiggere Malebranche una volta per tutte.
...
- **Vecna**: è sempre presente come minaccia. Se i PG ignorano le sue richieste, subiscono maledizioni progressive (tabella d6 nel Modulo B). Non è un nemico da combattere direttamente — è un burattinaio.
...
- **Difficoltà**: l'avventura scala da lv8 (Modulo A) a lv10 (Moduli C-D). Gli incontri sono calibrati per 4-6 PG. Il Modulo A ha molte opzioni non-combat; il Modulo D è il più combat-heavy.
...
- **Frankie Partenope** — barbaro umano lv5, ex avventuriero ed eroe del popolo. Costretto a collaborare con i PG nel Modulo A (collare esplosivo). Odia Malebranche. Torna nel Modulo D come alleato.
- **Malachias Ombrascura** (alias Elemir Strunz) — chierico dragonide, ha rubato la Pergamena del Giudizio. Si nasconde a Orcastle sotto falsa identità. Torna nel Modulo D.
- **Brother Thaddeus** — monaco, ex discepolo di Tyr. Ha lasciato l'ordine dopo aver scoperto le vere intenzioni di Alaric. Offre informazioni cruciali nel Modulo B.
- **Ludmilla Dawnshield** — esploratrice umana, discendente dei primi esploratori di Svoalbard. Guida i PG verso l'isola nel Modulo C.
- **Helmut Van Heuten** — mercante devoto a Tyr, finanzia e supporta la missione nel Modulo C.

### Antagonisti

- **Lord Cedric Malebranche** — arcimago necromante, governatore corrotto. Mandante del rapimento nel Modulo A. Villain finale nel Modulo D.
- **Sir Alaric il Giusto** — alto sacerdote dei Custodi dell'Equilibrio. Nasconde ambizioni di potere assoluto. Antagonista del Modulo B.
- **Othran Vorash** — mezzelfo warlock di Vecna, lv10. Insegue i PG per rubare lo Scettro nei Moduli C-D.
- **Zalhara Lorenn** — spia umana al servizio di Vecna. Viaggia sulla stessa nave dei PG nel Modulo C.

### Fazioni di Orcastle (Modulo A)
...
- **Lord Kreig Highlander** — leader del Castro (centro), cugino segreto di Malebranche. Diventa conte nel Modulo D.
...
### La Pergamena del Giudizio (Modulo A)
...
### La Coppa di Blackwood (Modulo A)
...
### Il Monile d'Oro di Ostegard (Modulo D)

Talismano che canalizza energia sacra per disperdere la corruzione necromantica. Custodito nel Santuario Sommerso di Ostegard, protetto da Sir Aldric (sword wraith).

## Struttura dell'avventura

| # | nome | livello | tipo | file |
|---|------|---------|------|------|
| A | Fuga da Orcastle | lv8, 5-6 PG | sandbox / esplorazione | [01_FugaDaOrcastle/FugaDaOrcastle.md](01_FugaDaOrcastle/FugaDaOrcastle.md) |
| B | Lo Scettro di Tyr | lv9, 4-5 PG | viaggio / dungeon | [02_LoScettroDiTyr/LoScettroDiTyr.md](02_LoScettroDiTyr/LoScettroDiTyr.md) |
| C | Ritorno a Casa | lv10, 4-5 PG | viaggio / intrigo | [03_RitornoACasa/RitornoACasa.md](03_RitornoACasa/RitornoACasa.md) |
| D | La fine non appartiene ai morti | lv10, 5-6 PG | viaggio / combat | [04_LaFineNonAppartieneAiMorti/LaFineNonAppartieneAiMorti.md](04_LaFineNonAppartieneAiMorti/LaFineNonAppartieneAiMorti.md) |

## Agganci futuri

- Il patto con Vecna alla Torre di Torth (Modulo A) può essere un hook per avventure successive
- Le tre azioni del bene richieste da Tyr per diventare puri (Modulo B) possono essere hook per one-shot
- La voce finale di Tyr a Svoalbard (Modulo C) promette una chiamata futura contro Vecna
- Il matrimonio di Tungsten (epilogo Modulo D) è un punto di partenza naturale per nuove avventure
