...
Usage:
    python3 tech/scripts/rtl-to-json.py tech/templates/rooms/bedroom.rtl
    python3 tech/scripts/rtl-to-json.py tech/templates/rooms/bedroom.rtl -o out.json

Default output: tech/build/rooms/<stem>.json
"""
