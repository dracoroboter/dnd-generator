...
Usage:
    python3 tech/scripts/enrichment-to-description.py \\
        tech/reports/dungeon_enrichment.json \\
        --dungeon tech/reports/dungeon_base.json \\
        --md tech/reports/dungeon_base.md
"""
