...
Usage:
    python3 tech/scripts/template-apply.py tech/reports/dungeon_base.json \\
        --room S4 --template bedroom [--seed 42] \\
        --output tech/reports/dungeon_enrichment.json
...
def get_object_template(obj_type):
    """Load tech/templates/objects/<obj_type>.json. type may contain spaces (e.g. 'large_table')."""
